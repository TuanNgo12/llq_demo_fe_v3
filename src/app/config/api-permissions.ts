...
//     { method: 'GET', path: '/api/components', roles: [APP_ROLES.MAKER, APP_ROLES.ADMIN], description: 'Xem danh sách component' },
//     { method: 'POST', path: '/api/group-category/add', roles: [APP_ROLES.MAKER, APP_ROLES.ADMIN], description: 'Tạo mới đề xuất' },
//     { method: 'POST', path: '/api/group-category/update', roles: [APP_ROLES.MAKER, APP_ROLES.ADMIN], description: 'Chỉnh sửa đề xuất' },
//     { method: 'POST', path: '/api/group-category/delete', roles: [APP_ROLES.MAKER, APP_ROLES.ADMIN], description: 'Xóa đề xuất' },
//     { method: 'POST', path: '/api/group-category/panding', roles: [APP_ROLES.MAKER, APP_ROLES.ADMIN], description: 'Gửi duyệt' },
//     { method: 'POST', path: '/api/group-category/cancel', roles: [APP_ROLES.MAKER, APP_ROLES.ADMIN], description: 'Hủy phê duyệt' },
//     { method: 'POST', path: '/api/group-category/approve', roles: [APP_ROLES.CHECKER, APP_ROLES.ADMIN], description: 'Phê duyệt' },
